...
figure(2)
clf
plot(pak_ei_scat,'d--','markersize',markersize,'linewidth',linewidth)
hold on
...
plot(pak_ei_scat_log,'o-','markersize',markersize,'linewidth',linewidth)
...
plot(pak_ei_mfcc,'o--','markersize',markersize,'linewidth',linewidth)
hold on
plot(pak_average_mfcc,'*--','markersize',markersize,'linewidth',linewidth)
plot(pak_emd_mfcc,'v--','markersize',markersize,'linewidth',linewidth)
plot(pak_closest_mfcc,'^--','markersize',markersize,'linewidth',linewidth)


plot(pak_ei_scat_log,'o-','markersize',markersize,'linewidth',linewidth)
plot(pak_average_scat_log,'*-','markersize',markersize,'linewidth',linewidth)
plot(pak_emd_scat_log,'v-','markersize',markersize,'linewidth',linewidth)
plot(pak_closest_scat_log,'^-','markersize',markersize,'linewidth',linewidth)

hold off
legend({'ei, mfcc','ob-a, mfcc','ob-w, mfcc','ob-c, mfcc', ...
    'ei, time-scattering','ob-a, time-scattering','ob-w, time-scattering','ob-c, time-scattering'},'interpreter','none')
legend('boxoff')
xlabel('k')
ylabel('p@k')
box off
...
printFigures([3],['~/papers/paperStructureScene16/paper/gfx/unsupervised_' dataset],figOpt)