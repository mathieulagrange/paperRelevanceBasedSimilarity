...
Experiments have been performed in the Matlab environment using open source libraries an all the authors are committed to comply to the reproducible research statements. The replication code is now available in beta, and will be doubled checked very soon.
...
%They are added as supplementary material in manuscript central and will be available on the code repository.
