...
As shown in Figure, log-scattering coefficients consistently outperform $MFCCs$ over all folds of the DCASE 2013 private dataset.
...
In order to evaluate how general these results are, we have taken part in the acoustic scene classification task 2016 edition of the DCASE challenge.
