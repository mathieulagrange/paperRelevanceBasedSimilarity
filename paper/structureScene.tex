...
\begin{IEEEkeywords}
unsupervised learning, classification algorithms, clustering algorithms, acoustic signal processing, wavelet transforms, audio databases, content-based retrieval, nearest neighbor searches, acoustic sensors, environmental sensors.
\end{IEEEkeywords}
...
The implementations of the presented methods and the experimental protocol are available online.\footnote{\url{https://github.com/mathieulagrange/taslp16}} % \ja{What is ``the one''?}
