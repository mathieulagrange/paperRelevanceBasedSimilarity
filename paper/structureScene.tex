...
The scattering transform is a multiscale representation of audio signals which cascades an auditory filterbank and a modulation filterbank, interspersed with complex modulus nonlinearities.
The modulation filterbank may either be performed solely on the time variable or on both time and frequency.
In this section, we present the design of both the temporal scattering transform and the time-frequency scattering transform.
