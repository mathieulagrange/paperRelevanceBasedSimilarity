...
Many pattern recognition algorithms, including nearest neighbour classifiers and support vector machines, tend to work best when all features follow a standard normal distribution across all training instances.

%Logarithmic compression is corroborated by psychoacoustics
% linearizes the dependency with respect to the distance to the source

And\'en \cite{Anden2014}
\begin{equation}
...
The next section discusses more advanced methods for the temporal integration of scattering coefficients in an unsupervised setting.
