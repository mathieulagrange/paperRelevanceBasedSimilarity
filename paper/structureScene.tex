...
See text for details.\ml{je mettrai des lignes fines entre les points 1 et 3, et 4 et 6, je zoomerai un peu et l'axe des y n'est pas numerote ni labelise }}
\end{center}
\ref{fig:folds}
\end{figure}
