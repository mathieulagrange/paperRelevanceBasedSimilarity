...
\cite{Anden2015}
%The temporal scale $2^{\gamma_2}/\xi_2$ takes $5$ values between $23\,\mathrm{ms}$ and $370\,\mathrm{ms}$.
%The log-frequential scale $\beta$ takes $5$ values between $1/4^{\mathrm{th}}$ of an octave and $4$ octaves, as well as their $5$ "mirror" frequencies,
%according to a geometric sequence.
%In addition, the edge case $\gamma_{\mathrm{fr}} = \infty$ corresponds
%to a log-frequential low-pass filter along $4$ octaves
%according to all $5$ temporal scales $2^{\gamma_2}/\xi_2$.
