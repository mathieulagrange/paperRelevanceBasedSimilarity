...
\end{tabular}
\end{center}
\caption{Algorithms evaluated on the DCASE2013 ASC private DCASE2013 dataset. RQA stands for recurrence quantification analysis, ILD for inter-aural differences and UL for unsupervised learning. Algorithms above the horizontal line participated to the DCASE challenge. Others used the private dataset afterward.  \label{tab:dcase}}
\end{table}
