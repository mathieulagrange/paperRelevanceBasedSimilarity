...
However, to achieve invariance to translation up to $T = 186\,\mathrm{ms}$, \ie of the order of the minimal duration between non-overlapping acoustic events, however, two layers of scattering transform of the audio signal $\boldsymbol{x}(t)$ suffice.
