...
\begin{abstract}
The emerging field of computational ecoacoustics aims at retrieving high-level information from the acoustic scenes recorded by some network of sensors. Large amount of unlabeled data are gathered using those networks that needs to be analyzed. In order to identify which parts needs human inspection, one needs tools that can mine data and identify structural such as recurring patterns or on contrary sparse occurences. To do so, one needs to be able to measure the level of similarity among the data without strong assumptions.

State of the art approaches for computing such a similarity is the "bag-of-frames" approach, i.e. modeling the audio using the summary statistics of short-term audio descriptors, such as mel-frequency cepstral coefficients (MFCCs).
...
This is because the scattering transform cascades wavelet convolutions and pointwise nonlinearities, thus imitating the architecture of a convolutional neural network \cite{} \vl{some relevant refs on dnns 4 audio}.

For the task at at hand, the scattering features have the valuable advantage of not requiring training and thus potentially lead to wider range of application than trained. Indeed, the task at hand is the mining of yet unheard audio datasets and the properties of the audio that are of interest remains to be
...
The implementations of the presented methods and the experimental protocol are available online.\footnote{\url{https://github.com/mathieulagrange/tetci17}} % \ja{What is ``the one''?}
...
\begin{tabular}{llll}
             ...
             \hline
\emph{early}, linear  & $54\pm19$   & $62\pm\phantom{0}6$  & $66\pm11$     \\
\emph{early}, RBF     & $47\pm16$  & $61\pm\phantom{0}9$  & $63\pm\phantom{0}6$   \\
\emph{late}, linear  & $60\pm\phantom{0}9$ & $70\pm\phantom{0}8$  & $75\pm\phantom{0}5$   \\
\emph{late}, RBF     & $68\pm14$ & $73\pm\phantom{0}6$  & $\mathbf{78}\pm\phantom{0}6$   \\
\end{tabular}
\end{center}
\end{table}
...
\begin{table}
\begin{center}
\caption{Class-wise accuracies on the DCASE 2016 dataset.\label{table:dcase2016}}
\begin{tabular}{lccc}
Features & MFCCs & log-scattering & log-scattering \\
Subset & development & development & evaluation \\
\midrule
beach & $58.3 \pm 28.2$ & $83.5 \pm \phantom{0}7.1$ & $80.8$\\
bus & $58.2 \pm 25.4$ & $88.8 \pm 11.4$ & $92.3$ \\
cafe/restaurant & $77.4 \pm 14.7$ & $64.5 \pm \phantom{0}8.3$ & $50.0$ \\
car & $92.3 \pm \phantom{0}7.7$ & $94.9 \pm \phantom{0}6.1$ & $96.2$ \\
city\_center & $96.4 \pm \phantom{0}3.8$ & $91.7 \pm \phantom{0}9.4$ & $84.6$ \\
forest\_path & $67.7 \pm 30.8$ & $93.8 \pm \phantom{0}7.8$ & $96.2$ \\
grocery\_store & $44.7 \pm 24.8$ & $90.9 \pm \phantom{0}6.9$ & $84.6$ \\
home & $44.8 \pm 15.3$ & $56.2 \pm 23.9$ & $80.8$ \\
library & $54.6 \pm 20.3$ & $82.0 \pm 13.0$ & $65.4$ \\
metro\_station & $94.7 \pm \phantom{0}6.8$ & $96.0 \pm \phantom{0}2.3$ & $96.2$ \\
office & $95.7 \pm \phantom{0}7.5$ & $87.5 \pm 21.7$ & $100$ \\
park & $52.4 \pm 10.4$ & $75.4 \pm \phantom{0}7.4$ & $65.4$ \\
residential\_area & $53.2 \pm 17.0$ & $44.2 \pm 15.0$ & $69.2$ \\
...
On the DCASE 2013 dataset, logarithmic compression provides a small, albeit consistent boost to acoustic scene classification.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=\columnwidth]{bw/unsupervised_test2}
