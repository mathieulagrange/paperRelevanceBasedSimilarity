...
Outcomes for the time-scattering with and without log compression are showed in Figure~\ref{fig:ASS_2}. It can be seen that the log compression strongly improves the results, specially for the \emph{ob} approaches, which perform lesser than \emph{ei} without the log compression. \gl{une idée du pourquoi ?}
