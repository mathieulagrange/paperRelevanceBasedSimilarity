...
However, to achieve invariance to translation up to $T = 372\,\mathrm{ms}$, \ie the approximately minimal duration between non-overlapping acoustic events, corresponding to $2^14 = 16384$ discrete-time samples at $44100\,\mathrm{Hz}$, two layers of scattering transform.
