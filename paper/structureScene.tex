...
As seen in Figure \ref{fig:ASS_-1}, the BOF approach behaves similarly to the early approach when applied to the two types of features.

TODO ML comment new figure
