...
where $c_N$ is the $N^{\mathrm{th}}$ nearest neihgbor of the centroid $c_i$, and $\parallel \bullet \parallel$ denotes the Euclidean norm. 
...
\caption{ASS: $p@k$ obtained for MFCCs and scattering with logarithmic compression}
\label{fig:ASS_1}
\end{center}
\end{figure}
...
\caption{ASS: $p@k$ obtained for scattering with and without logarithmic compression (w/o log)}
\label{fig:ASS_2}
\end{center}
\end{figure}
