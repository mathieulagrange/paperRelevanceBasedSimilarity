...
In this article, we address the problem of acoustic scene classification (ASC) according to the taxonomy of the DCASE 2013 challenge, both in supervised and unsupervised settings.
