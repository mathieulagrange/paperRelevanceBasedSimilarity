...
\ml{What is the early integration approach here? We should define it.}
...
The clustering for the \emph{RbQ} approaches is done using plain $k$-means with random initialization and $200$ replicates. For each method, the numbers of clusters is set to the value among $8$, $16$ and $32$ that leads to the best $p@9$ on the training set. \ml{What's the training set here?}
