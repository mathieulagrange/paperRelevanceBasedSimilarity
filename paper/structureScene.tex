...
A closely related, and more mature, field of investigation is the classification of acoustic scenes, where the aim is to predict labels by processing audio data. \cite{So what's the difference between ecoacoustics and acoustic scene classification?}
